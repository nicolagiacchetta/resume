...
\textbf{Other}: Consul, Docker, Bash, XML, JSON,\\ PHP, C/C++ 
%CORBA, \LaTeX
~
\vspace{-0.1cm}
\section{\normalfont interests}
...
\begin{itemize}[leftmargin=.6cm]
	...
	\item implemented a service to perform Failure Detection and health statuses aggretation
	\item worked on a tool to perform cross-DC MySql Master-Slave replication and Master failover
